...
--------------------------------|------------
subject                         | ID of the subject who perfromed the activity. Range from 1-30
activity                        | Detailed description of performing activity
tBodyAcc-mean/std()-X/Y/Z       | Average time domain body acceleration mean or std, on X or Y or Z axis
tGravityAcc-mean/std()-X/Y/Z    | Average time domain gravity acceleration mean or std, on X or Y or Z axis
tBodyAccJerk-mean/std()-X/Y/Z   | Average time domain body acceleration jerk signal mean or std, on X or Y or Z axis
tBodyGyro-mean/std()-X/Y/Z      | Average time domain angular velocity vector mean or std, on X or Y or Z axis
tBodyGyroJerk-mean/std()-X/Y/Z  | Average time domain angular velocity vector jerk siganl mean or std, on X or Y or Z axis
...                             | ...

Note that explanation of frequency domain attributes are similar to their time domain counterparts, except that the values are obtained in frequency domain using Fast Fourier Trasform.
